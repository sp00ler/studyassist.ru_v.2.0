...
const steps = [
  {
    ...
    description: 'Опишите задание: тип работы, предмет, дедлайн и требования. Приложите методичку или дополнительные материалы.',
    color: '#6C3EF4',
  },
  {
    number: '02',
    ...
    description: 'В течение 30 минут мы рассчитаем стоимость и согласуем все детали. Никаких скрытых платежей.',
    color: '#3B82F6',
  },
  {
    number: '03',
    icon: Download,
    title: 'Оплатите — и мы приступаем',
    description: 'После согласования стоимости вносите оплату — и мы сразу приступаем к выполнению вашей работы. Правки в рамках первоначального задания бесплатно.',
    color: '#F59E0B',
  },
]
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/50 text-lg max-w-2xl mx-auto">
            Три простых шага — и ваша работа готова
          </p>
        </motion.div>
