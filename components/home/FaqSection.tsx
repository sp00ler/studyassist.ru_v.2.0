...
const faqs = [
  {
    ...
    answer:
      'Консультация по большинству предметов доступна в течение 30–60 минут после согласования. Для репетиторских занятий мы подбираем удобное время вместе с вами. Точные сроки согласовываются индивидуально после получения вашего запроса.',
  },
  {
