...
const STATIC_REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Готовилась к экзамену по фармакологии с помощью репетитора. За 3 занятия систематизировали весь материал, разобрали сложные препараты. Сдала на отлично, спасибо!',
    date: '07.11.2024',
