...
export const metadata: Metadata = {
  title: 'StudyAssist — Образовательные консультации для студентов | Репетиторство и помощь в учёбе',
  description:
    'Профессиональные консультации для студентов: объяснение тем, репетиторство, подбор материалов и литературы, помощь в подготовке к экзаменам. Быстро, качественно, конфиденциально.',
  keywords:
    'консультации для студентов, репетитор онлайн, подбор учебных материалов, помощь в учёбе, подготовка к экзаменам, образовательные консультации, StudyAssist',
  alternates: {
    canonical: '/',
  },
}
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Консультация по большинству предметов доступна в течение 30–60 минут. Репетиторские сессии планируются заранее.',
          },
        },
        {
          '@type': 'Question',
