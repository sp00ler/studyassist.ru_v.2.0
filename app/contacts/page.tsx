...
function MaxIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-1.2 14V8.8L7.6 14H6.4L3.8 8.8V16H2.4V7h1.8l2.7 5.6L9.6 7h1.8v9h-1.4zm7.8 0l-1.2-2.4h-3.6L12.6 16h-1.6L14.4 7h1.6L20 16h-1.4zm-4.2-3.6h2.8L15.8 9.4l-1.4 3z"/>
    </svg>
  )
}
